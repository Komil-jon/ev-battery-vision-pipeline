...
\caption{Two frames from the flagged source with their released annotations. Twelve
boxes in each carry the label \texttt{module}, every one covering a small internal
sub-component; the pack-level modules that every other source annotates are left
unmarked. Median normalised module scale is 0.114 and 0.077 respectively, against 0.14
